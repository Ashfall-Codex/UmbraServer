...
namespace MareSynchronosServer.Migrations
{
    ...
    [Migration("20260718080021_AddBc7Conversions")]
    partial class AddBc7Conversions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.CharacterRpProfileData", b =>
                {
                    ...
                    b.Property<byte>("RpLevel")
                        .HasColumnType("smallint")
                        .HasColumnName("rp_level");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.FileBc7Conversion", b =>
                {
                    ...
                    b.Property<string>("AlternateHash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("alternate_hash");
                    ...
                    b.HasKey("SourceHash")
                        .HasName("pk_file_bc7_conversions");

                    b.HasIndex("AlternateHash")
                        .HasDatabaseName("ix_file_bc7_conversions_alternate_hash");

                    b.HasIndex("State")
                        .HasDatabaseName("ix_file_bc7_conversions_state");

                    b.ToTable("file_bc7_conversions", (string)null);
                });
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_housing_scenarios");

                    b.HasIndex("OwnerUID")
                        .HasDatabaseName("ix_housing_scenarios_owner_uid");

                    b.HasIndex("ServerId", "TerritoryId", "DivisionId", "WardId", "HouseId")
                        .HasDatabaseName("ix_housing_scenarios_server_id_territory_id_division_id_ward_i");

                    b.ToTable("housing_scenarios", (string)null);
                });

            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenarioAllowedGroup", b =>
                {
                    ...
                    b.HasKey("ShareId", "AllowedGroupGid")
                        .HasName("pk_housing_scenario_allowed_groups");

                    b.HasIndex("AllowedGroupGid")
                        .HasDatabaseName("ix_housing_scenario_allowed_groups_allowed_group_gid");

                    b.ToTable("housing_scenario_allowed_groups", (string)null);
                });

            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenarioAllowedUser", b =>
                {
                    b.Property<Guid>("ShareId")
                        .HasColumnType("uuid")
                        .HasColumnName("share_id");
                    ...
                    b.HasKey("ShareId", "AllowedIndividualUid")
                        .HasName("pk_housing_scenario_allowed_users");

                    b.HasIndex("AllowedIndividualUid")
                        .HasDatabaseName("ix_housing_scenario_allowed_users_allowed_individual_uid");

                    b.ToTable("housing_scenario_allowed_users", (string)null);
                });
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenario", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.User", "Owner")
                        ...
                        .HasForeignKey("OwnerUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_housing_scenarios_users_owner_uid");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenarioAllowedGroup", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.HousingScenario", "Share")
                        .WithMany("AllowedSyncshells")
                        .HasForeignKey("ShareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_housing_scenario_allowed_groups_housing_scenarios_share_id");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.HousingScenarioAllowedUser", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.HousingScenario", "Share")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_housing_scenario_allowed_users_housing_scenarios_share_id");
            ...
            modelBuilder.Entity("MareSynchronosShared.Models.UserDefaultPreferredPermission", b =>
                {
                    b.HasOne("MareSynchronosShared.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("MareSynchronosShared.Models.UserDefaultPreferredPermission", "UserUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
